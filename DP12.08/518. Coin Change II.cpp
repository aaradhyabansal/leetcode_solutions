...
//Tabulation solution TC-O(n^2) SC-O(n*k)
class Solution {
public:
...
int coinChangeTab(vector<int>& coins,int amt)
{
    int n=coins.size();
    ...
    int change(int amount, vector<int>& coins) {
       ...
       // return coinChangeRec(coins,amt,coins.size()-1);
       // return coinChangeMemoi(coins,amt,coins.size()-1,dp);
       return coinChangeTab(coins,amt);

    }
};

//Tabulation Space Optimised solution TC-O(n^2) SC-O(k)
...
int coinChangeTabSO(vector<int>& coins,int amt)
{
    int n=coins.size();
   vector<int>prev(amt+1,0),curr(amt+1,0);
    ...
    int change(int amount, vector<int>& coins) {
       ...
       // return coinChangeMemoi(coins,amt,coins.size()-1,dp);
    //    return coinChangeTab(coins,amt);
    return coinChangeTabSO(coins,amt);
    }
};